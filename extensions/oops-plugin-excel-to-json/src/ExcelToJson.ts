 ...
 */
async function convert(src: string, dst: string, ts: string, name: string, isClient: boolean) {
    const r: any = {};
    let keys: any[] = [];
    let types: any[] = [];
    let servers: any[] = [];
...
export function run(src: string, dst: string, ts: string) {
